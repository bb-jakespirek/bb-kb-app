module.exports = {
	...
	updateTicketRequester: function(ticket_id, requester_id) {
		return {
			url: '/api/v2/tickets/'+ticket_id+'.json',
			dataType: 'json',
			type: 'PUT',
	...
	openTicketTab: function(id, current_user_id) {
		// console.log("openTicketTab ran");
		return {
			url:  '/api/v2/channels/voice/agents/'+current_user_id+'/tickets/'+ id +'/display.json',
			type: 'POST'
		};
	},
